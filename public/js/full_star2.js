...
function tick(evt) {
            ...
            for(var i=0; i<CIRCLES; i++) {
                ...
                var g = new createjs.Graphics().beginFill(color).drawPolyStar(centerX, centerY, lastRadius, 5, 0.3, -90);
...
function getWaveImg(thickness) {
			...
			waveShape.graphics.setStrokeStyle(thickness).beginStroke ("#FFF").drawPolyStar(0, 0, WAVE_RADIUS, 7, 0.2, -90);
